...
_subparsers = parser.add_subparsers(dest="subcommand", help="리마인더 명령어를 입력하세요.")

set_parser = _subparsers.add_parser("set", help="리마인더를 설정합니다.", add_help=False)
...
list_parser = _subparsers.add_parser("list", help="리마인더 목록을 출력합니다.", add_help=False)
...
__all__ = ['parser', 'set_parser', 'list_parser']
